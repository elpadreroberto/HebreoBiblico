...
import { a as getBaseURL, i as PACKAGE_VERSION, r as GENERIC_OAUTH_ERROR_CODES } from "./router-CudEm2Lo.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app-shell-BdDM6Chw.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[background-color,color,box-shadow,transform,opacity] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:not-disabled:scale-[0.96]", {
	variants: {
		variant: {
			...
			secondary: "bg-raised text-fg shadow-[0_0_0_1px_var(--color-border)] hover:bg-raised/80",
			ghost: "text-muted hover:bg-raised hover:text-fg",
			outline: "bg-transparent text-fg shadow-[0_0_0_1px_var(--color-border)] hover:bg-raised",
			teal: "bg-teal text-teal-fg hover:bg-teal/90",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			user.profileImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: "grid h-8 w-8 place-items-center rounded-full bg-raised text-sm font-medium text-accent",
				children: label.charAt(0).toUpperCase()
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "hidden max-w-[8rem] truncate text-sm font-medium text-fg sm:inline",
				children: label
			}),
...
function AuthSlot() {
	...
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "size-9 animate-pulse rounded-full bg-raised",
		"aria-hidden": "true"
	});
	if (user) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "max-w-[10rem] truncate text-sm text-muted sm:max-w-none",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								dir: "rtl",
								lang: "he",
								className: "font-hebrew text-xs text-muted",
								children: "עִבְרִית"
							})]
						})]
						...
						children: [NAV.map((item) => {
							const active = item.to === "/" && current === "home" || item.to === "/alefato" && current === "alefato" || item.to === "/vocabulario" && current === "vocabulario";
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: item.to,
								"aria-current": active ? "page" : void 0,
								className: cn("hidden h-11 items-center rounded-md px-3 text-sm font-medium transition-colors duration-150 sm:inline-flex", active ? "bg-raised text-fg" : "text-muted hover:bg-raised/70 hover:text-fg"),
								children: item.label
							}, item.to);
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthSlot, {})]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex gap-1 border-t border-border px-2 py-1 sm:hidden",
					...
					children: NAV.map((item) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: item.to,
							"aria-current": active ? "page" : void 0,
							className: cn("flex h-10 flex-1 items-center justify-center rounded-md text-sm font-medium", active ? "bg-raised text-fg" : "text-muted"),
							children: item.label
						}, item.to);
					})
				})]
...
//#endregion
export { signIn as a, shuffle as i, Button as n, cn as r, AppShell as t };
