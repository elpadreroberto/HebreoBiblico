...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CudEm2Lo.js
...
var styles_default = "/assets/styles-Da08GzOm.css";
var APP_NAME = "Hebreo Bíblico";
var FONT = "https://fonts.googleapis.com/css2?family=Frank+Ruhl+Libre:wght@400;500;700&family=Noto+Serif+Hebrew:wght@400;600;700&family=Source+Sans+3:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Source+Serif+4:opsz,wght@8..60,500;8..60,600;8..60,700&display=swap";
var Route$5 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Aprende hebreo bíblico: alefato, vocales, gramática y el vocabulario que cubre el 97% del Tanaj."
			},
			{
				name: "theme-color",
				content: "#0b0e14"
...
var $$splitComponentImporter$3 = () => import("./routes-CGMUBbcM.mjs");
var Route$4 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./alefato-F0DFmcvX.mjs");
var Route$3 = createFileRoute("/alefato")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./login-Biv-BVNb.mjs");
var Route$2 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./vocabulario-B3v-OElE.mjs");
var Route$1 = createFileRoute("/vocabulario")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
/**
...
var rootRouteChildren = {
	...
	VocabularioRoute: Route$1.update({
		id: "/vocabulario",
		path: "/vocabulario",
		getParentRoute: () => Route$5
	}),
